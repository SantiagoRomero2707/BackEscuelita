...
from ControllerGraphQL.Entity.IPS_SERVICIO.actions_graph.query import IPSServicioQuery
...
@strawberry.type
class Query(EPSQuery, FarmaciaQuery, HorarioQuery, IPSQuery, MedicoQuery, EPSIPSQuery,IPSServicioQuery, EPSFarmaciaQuery,JornadaQuery,IPSJornadaQuery, ServicioQuery, AfiliadosQuery, MedicoHorarioQuery):
    pass
